...
The conventions this lab follows (single source of truth, targeted Ansible runs, replace rules, storage lessons learned): [docs/best-practices.fr.md](docs/best-practices.fr.md) 🇫🇷
